...
- question: 진짜 궁금한 거 다른 사람한테 묻는 글. "나 이거 해보고 싶은데 다들 어떻게 해?" / "이런 경험 다들 한 번씩 있지 않나?" / "솔직히 이런 거 어디서 사?" 같은 톤. 반드시 글 끝에 물음표로 끝내고, 댓글로 자기 경험·의견 적고 싶게 만들어야 함. 광고스럽거나 추천 톤 절대 금지. 진짜 내 일상 고민/궁금증을 친구한테 묻는 것처럼.
  ★참고 사례(실측 2026-07, 복제 금지): 다들 당연하다고 여기는 생활 매너·습관(식사 예절, 약속, 계산 등)에 의문을 던지고 자기 원칙을 짧게 밝히는 저녁 글이 크게 터진 적 있음(음식 덜어먹기 질문 78,000뷰·1,170답글). 단 이건 "이런 결이 통한다"는 참고일 뿐 — "국룰 아니었음?" 같은 특정 표현·패턴을 반복하면 금방 식상해지므로 절대 도배 금지, 매번 완전히 다른 소재·형식으로.
