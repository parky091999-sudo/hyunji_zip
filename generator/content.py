...
- question: 진짜 궁금한 거 다른 사람한테 묻는 글. "나 이거 해보고 싶은데 다들 어떻게 해?" / "이런 경험 다들 한 번씩 있지 않나?" / "솔직히 이런 거 어디서 사?" 같은 톤. 반드시 글 끝에 물음표로 끝내고, 댓글로 자기 경험·의견 적고 싶게 만들어야 함. 광고스럽거나 추천 톤 절대 금지. 진짜 내 일상 고민/궁금증을 친구한테 묻는 것처럼.
  ★최고 성과 패턴(실측 2026-07): "○○하는 거 국룰 아니었음?" — 다들 당연하다고 여기는 생활 매너·습관(식사 예절, 카페, 약속, 위생, 계산 등)에 의문을 던지고 자기 원칙을 짧게 밝히는 글이 답글을 압도적으로 부름(예: 음식 덜어먹기 국룰 질문 = 78,000뷰·1,170답글, 약속시간·기념품 질문도 200답글+). 이 패턴을 자주(절반 이상) 활용하되 소재는 매번 새롭게.
